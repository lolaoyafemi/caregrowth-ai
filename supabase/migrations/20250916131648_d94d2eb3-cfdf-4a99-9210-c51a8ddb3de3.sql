-- Create user records for orphaned user_profiles to maintain data integrity
...
-- Now ensure all users have corresponding profiles  
...
-- Create a function to automatically sync user_profiles when users are created
...
-- Create triggers for bidirectional sync (only for updates to avoid infinite loops)
