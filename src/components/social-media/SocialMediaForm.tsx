          ...
          <div className="mt-8">
            ...
            {credits <= 0 && (
              <p className="text-sm text-red-600 mt-2 text-center">
                You need credits to generate content. <a href="https://buy.stripe.com/3cI28sbNC05F3QCeXHbsc0y?success_url=https%3A%2F%2Fwww.caregrowthassistant.com%2Fpayment-success%3Fplan%3Dprofessional" target="_blank" rel="noopener noreferrer" className="underline">Buy credits</a>
              </p>
            )}
          </div>
        </div>
